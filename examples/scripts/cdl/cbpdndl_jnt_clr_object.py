...
from sporco.admm import object
# from sporco.admm import parcbpdn     # parallel dummy test
...
# optx = parcbpdn.ParConvBPDN.Options({'Verbose': False, 'MaxMainIter': 1,     # parallel dummy test
#             'rho': 50.0*lmbda + 0.5, 'AutoRho': {'Period': 10,
#             'AutoScaling': False, 'RsdlRatio': 10.0, 'Scaling': 2.0,
#             'RsdlTarget': 1.0}})
...
# xstep = parcbpdn.ParConvBPDN(D0n, sh,lmbda,None,optx) # parallel dummy test
...
"""
Create X update object for object project (wrapper).
"""

zstep = object.AKConvBPDN(xstep,D0n, sh, lmbda, mu, optx)
...
d = dictlrn.DictLearn(zstep, dstep, opt)
D1 = d.solve()
